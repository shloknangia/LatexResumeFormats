...
{\fontsize{15pt}{15pt}\fontspec[Path = fonts/lato/]{Lato-Lig}\selectfont Software Engineer }\\
...
\location{July 2018 | Delhi, IN \\CGPA: \textbf{8.87}}
\sectionsep
...
\location{July, 2018 – Current | Pune, IN}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightemize}
